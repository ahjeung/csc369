I first plotted pixels that were first placed on each coordinate. \
![alt text](rplaceFirstPixels.png)\
\
Many flags appeared as soon as r/place started and as it expanded the canvas\
over the next 2 days. \
\
I also plotted pixels that were placed within 10 minutes of r/place starting or \
expanding. I couldn't find the exact times r/place expanded on 4/2 and 4/3, so \
is a rough estimate for those days. The top left quadrant is the original r/place on 4/1,\
